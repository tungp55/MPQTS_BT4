function Behavior__Pursue_Formation_Column()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Column-Formation and Pursue behavior';
...
while (timeTick < TimeSteps)
    ...
    %% Moving Boids
    Leader = Boids(1, :);            
    [Boids, BoidsIndex] = steer_Pursue_Formation_Column(MousePosition, Boids, Leader, D_Behind);
...
%% Record video
MyMovie = VideoWriter('Column-Formation_PursueBehavior.avi');
open(MyMovie);
