...
function [CurrentBoid, Boids] = Move_Evade_Formations(Target, Weight, Boids, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
force = 2*steer_evade(CurrentBoid, Target, Target(4:6), FleeDistance);
