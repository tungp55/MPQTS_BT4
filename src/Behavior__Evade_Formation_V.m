function Behavior__Evade_Formation_V()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of V-Formation and Evade behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Evade_Formation_V(Target, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('V-Formation_EvadeBehavior.avi');
open(MyMovie);
