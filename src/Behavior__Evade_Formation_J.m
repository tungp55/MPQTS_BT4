function Behavior__Evade_Formation_J
global TimeSteps;
global BoidsNum;
global Boids;
global Targets;
...
titleStr = 'Implementation of J-Formation and Evade behavior';
...
while (timeTick < TimeSteps)
   ...
   force = 0.1*steer_arrival(Boids(1,:), RandomPosition); 
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Evade_Formation_J(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('J-Formation_EvadeBehavior.avi');
open(MyMovie);
