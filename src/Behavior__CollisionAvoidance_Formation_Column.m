...
titleStr = 'Implementation of Column-Formation and Collision Avoidance behavior';
...
while (timeTick < TimeSteps)        
    ...
    %% Moving Boids
    Leader = Boids(1, :);            
    [Boids, BoidsIndex] = steer_CollisionAvoidance_Formation_Column(Boids, Leader, D_Behind);
