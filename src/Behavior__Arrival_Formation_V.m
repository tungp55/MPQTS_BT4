function Behavior__Arrival_Formation_V()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of V-Formation and Arrival behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Arrival_Formation_V(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('V-Formation_ArrivalBehavior.avi');
open(MyMovie);
