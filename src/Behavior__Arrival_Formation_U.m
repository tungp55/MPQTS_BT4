function Behavior__Arrival_Formation_U()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of U-Formation and Arrival behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Arrival_Formation_U(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('U-Formation_ArrivalBehavior.avi');
open(MyMovie);
