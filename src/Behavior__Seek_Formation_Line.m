function Behavior__Seek_Formation_Line()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Line-Formation and Goal seeking behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Seek_Formation_Line(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('Line-Formation_GoalSeeking.avi');
open(MyMovie);
