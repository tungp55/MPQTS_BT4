...
function [CurrentBoid, Boids] = Move_Seek_Formations(Target, Weight, Boids, BoidsNum, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
separation_force = steer_separation(CurrentBoid,  BoidsNum, Boids);
