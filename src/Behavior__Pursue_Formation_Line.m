function Behavior__Pursue_Formation_Line()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Line-Formation and Pursue behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Pursue_Formation_Line(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('Line-Formation_PursueBehavior.avi');
open(MyMovie);
