function Behavior__Seek_Formation_V()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of V-Formation and Goal seeking behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Seek_Formation_V(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('V-Formation_GoalSeeking.avi');
open(MyMovie);
