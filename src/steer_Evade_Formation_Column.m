function [Boids, BoidsIndex]  = steer_Evade_Formation_Column(Target, Boids, Leader, D_Behind)
global BoidsNum;
...
WeightsMatrix = WeightFunction_Evade_Formation_Column(Target, Boids, BoidsNum, D_Behind);
...
[LeaderBehind, Boids] = Move_Evade_Formations(Target, Weight, Boids, LeaderBehind,Leader, BehindLeader, MinIndex);
...
while (sum(BoidsFlag) < BoidsNum)    
    ...
    Weight = WeightsMatrix(MinIndex);
    [NearestRight, Boids] = Move_Evade_Formations(Target, Weight, Boids, NearestRight,LeaderBehind,BehindLeader, MinIndex);
