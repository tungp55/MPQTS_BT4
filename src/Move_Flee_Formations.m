...
function [CurrentBoid, Boids] = Move_Flee_Formations(Target, Weight, Boids, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
force = 1.2*steer_flee(CurrentBoid, Target, FleeDistance);
