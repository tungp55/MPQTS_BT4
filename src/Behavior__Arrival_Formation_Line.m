function Behavior__Arrival_Formation_Line()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Line-Formation and Arrival behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Arrival_Formation_Line(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('Line-Formation_Arrival.avi');
open(MyMovie);
