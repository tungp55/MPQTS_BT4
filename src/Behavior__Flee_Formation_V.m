function Behavior__Flee_Formation_V()
%% global variables
global TimeSteps;
global FleeDistance;
global BoidsNum;
...
titleStr = 'Implementation of V-Formation and Flee behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Flee_Formation_V(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('V-Formation_FleeBehavior.avi');
open(MyMovie);
