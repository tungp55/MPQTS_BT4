function Behavior__Seek_Formation_Arc()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Arc-Formation and Goal seeking behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Seek_Formation_Arc(MousePosition, Boids, Leader, D_Behind, D_Beside,...
...
%% Record video
MyMovie = VideoWriter('Arc-Formation_GoalSeeking.avi');
open(MyMovie);
