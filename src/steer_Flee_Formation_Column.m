function [Boids, BoidsIndex]  = steer_Flee_Formation_Column(Target, Boids, Leader, D_Behind)
global BoidsNum;
...
WeightsMatrix = WeightFunction_Flee_Formation_Column(Target, Boids, BoidsNum, D_Behind);
...
[LeaderBehind, Boids] = Move_Flee_Formations(Target, Weight, Boids, LeaderBehind,Leader, BehindLeader, MinIndex);
...
while (sum(BoidsFlag) < BoidsNum)    
    ...
    Weight = WeightsMatrix(MinIndex);
    [NearestRight, Boids] = Move_Flee_Formations(Target, Weight, Boids, NearestRight,LeaderBehind,BehindLeader, MinIndex);
