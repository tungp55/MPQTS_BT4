...
titleStr = 'Implementation of Column-Formation and Goal seeking behavior';
...
while (timeTick < TimeSteps)
    ...
    %% Moving Boids
    Leader = Boids(1, :);            
    [Boids, BoidsIndex] = steer_Arrival_Formation_Column(MousePosition, Boids, Leader, D_Behind);
