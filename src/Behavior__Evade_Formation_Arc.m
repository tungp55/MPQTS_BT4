function Behavior__Evade_Formation_Arc()
%% global variables
global TimeSteps;
global BoidsNum;
global Boids;
...
titleStr = 'Implementation of Arc-Formation and Evade behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Evade_Formation_Arc(MousePosition, Boids, Leader, D_Behind, D_Beside,...
...
%% Record video
MyMovie = VideoWriter('Arc-Formation_EvadeBehavior.avi');
open(MyMovie);
