...
function [CurrentBoid, Boids] = Move_Pursue_Formations(Target, Weight, Boids, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
force = 0.8*steer_pursue(CurrentBoid, Target);
