function Behavior__Seek_Formation_J
global TimeSteps;
global BoidsNum;
global Boids;
global Targets;
...
titleStr = 'Implementation of J-Formation and Goal seeking behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Seek_Formation_J(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('J-Formation_GoalSeeking.avi');
open(MyMovie);
