function Behavior__Arrival_Formation_J
global TimeSteps;
global BoidsNum;
global Boids;
global Targets;
...
titleStr = 'Implementation of J-Formation and Arrival behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Arrival_Formation_J(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('J-Formation_Arrival.avi');
open(MyMovie);
