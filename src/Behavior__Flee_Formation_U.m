...
titleStr = 'Implementation of U-Formation and Flee behavior';
...
while (timeTick < TimeSteps)
    ...
    Leader = Boids(1, :);      
    Alpha_Horizontal = CalculationHorizontalAngle(Leader);        
    [Boids, BoidsIndex] = steer_Flee_Formation_U(MousePosition, Boids, Leader, ...
...
%% Record video
MyMovie = VideoWriter('U-Formation_FleeBehavior.avi');
open(MyMovie);
